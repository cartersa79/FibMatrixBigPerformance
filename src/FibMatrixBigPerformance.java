...
public class FibMatrixBigPerformance {
    ...
    static void runFullExperiment(String resultsFileName) {
        ...
        for (int inputSize = MININPUTSIZE; inputSize <= MAXINPUTSIZE; inputSize *= 2) {
            ...
            for (long trial = 0; trial < numberOfTrials; trial++) {
                ...
                BigInteger FibTest = FibMatrixBig(inputSize);
    ...
    static BigInteger FibMatrixBig(long x)
    {
        BigInteger F[][] = new BigInteger[][]{{BigInteger.valueOf(1),BigInteger.valueOf(1)},{BigInteger.valueOf(1),BigInteger.valueOf(0)}}; // create 2x2 matrix
        // handle 'base case'
        if (x == 0)
    ...
    static void MatrixMultiply(BigInteger F[][], BigInteger M[][])
    {
        BigInteger a =  F[0][0].multiply(M[0][0]).add(F[0][1].multiply(M[1][0])); // calculate top left value
        BigInteger b =  F[0][0].multiply(M[0][1]).add(F[0][1].multiply(M[1][1])); // calculate top right value
        BigInteger c =  F[1][0].multiply(M[0][0]).add(F[1][1].multiply(M[1][0])); // calculate bottom left value
        BigInteger d =  F[1][0].multiply(M[0][1]).add(F[1][1].multiply(M[1][1])); // calculate bottom right value
    ...
    static void MatrixPower(BigInteger F[][], long x)
    {
